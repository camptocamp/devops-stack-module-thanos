      ...
      bucketweb = {
        ...
        sidecars = [{
          args = concat([
            ...
            "--client-secret=<path:secret/data/devops-stack/internal/thanos#thanos-oidc-client-secret>",
            "--cookie-secure=false",
            "--cookie-secret=<path:secret/data/devops-stack/internal/thanos#thanos-oidc-cookie-secret>",
            "--email-domain=*",
