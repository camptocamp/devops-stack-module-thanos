...
*Since this module is meant to be instantiated using its submodules, the usage documentation is available in each submodule* ( xref:./eks/README.adoc[EKS] ).
// Example line with other submodules
