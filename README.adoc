...
:chart-version: 11.5.5
:repo-url-release-commit: https://github.com/bitnami/charts/tree/8ef44e189c6a143153e28f4ad8510b96a41b62a9/bitnami/thanos
...
|[[output_thanos_enabled]] <<output_thanos_enabled,thanos_enabled>> |Boolean indicating whether Thanos is enabled.
|===
// END_TF_TABLES
====
